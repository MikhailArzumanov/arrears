...
namespace arrearsApi5_0.Migrations{
    ...
    [Migration("20221229054018_AdministratorModelAddition")]
    partial class AdministratorModelAddition{
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("arrearsApi5_0.Models.Administrator", b =>{
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("arrearsApi5_0.Models.ArrearSheet", b =>{
                    ...
                    b.Property<DateTime>("FromationDate")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int>("MagisterId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("arrearsApi5_0.Models.ArrearSheet", b =>{
                    ...
                    b.HasOne("arrearsApi5_0.Models.Magister", "Magister")
                        .WithMany()
                        .HasForeignKey("MagisterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
